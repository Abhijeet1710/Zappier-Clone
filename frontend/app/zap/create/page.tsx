...
// import { Modal } from "@/components/AnimiatedModel";
...
function Modal({
  ...
  return (
      <div className="fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full bg-opacity-70 flex bg-black">
  ...
  return (
    <div>
      ...
      <span className="mb-4 text-sm font-light">
        {" "}
        For dynamic receiver email enter the path which you will add while
        calling the hook{" "}
      </span>
